...
После привязки с удаленным репозиторием, можно вызывать просто одну команду, которая автоматом будет пересылать все изменения на удаленныйрепозиторий - *git push"*
