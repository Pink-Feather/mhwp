...
9. Добавление удаленного/чужого репозитория репозитория (копирует репозиторий в другом месте и переносит всю содержание в наш репизиторий) - *git clone_(вставляем адрес ссылки репозитория)*
